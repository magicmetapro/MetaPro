...
def generate_metadata(model, img):
    caption = model.generate_content(["As a helpful Digital Asset Metadata Manager, analyze the following image and generate search engine optimized (SEO) titles for stock photography. Create a descriptive title in English that identifies the main elements of the image. Highlight the primary subjects, objects, activities, and context. Refine the title to include relevant keywords for SEO, ensuring it is engaging and informative. Avoid mentioning human names, brand names, product names, or company names.", img])
